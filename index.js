...
var helper = Array( // Arguments de Commandes
	...
	"--------------------",
	`\n -0 <x>d<y>    Demande à ${conf.name.toUpperCase()} de lancer x fois un dé de y faces avec le 0 compris`,
	` -!0 <x>d<y>   Demande à ${conf.name.toUpperCase()} de lancer x fois un dé de y faces en ignorant le 0`,
